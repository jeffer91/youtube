/*
  ...
  Función: definir el contrato que absorberá Entendimiento + Biblioteca antes de llamar a IA.
*/

export const VERSION_CONTEXTO_PLAN = '1.0.0';
...
export const SALIDA_PLAN_IA = Object.freeze({
  ...
  formatoTecnico: {
    timeline: 'array de acciones con inicio, fin, accion, textoPantalla, recursoBiblioteca, efecto, audio y motivo',
