export function renderResultadoView() {
  return `
    <section class="aj-view-card result-final-page" data-resultado-final-root data-proceso-root="resultado-final" data-proceso-paso-activo="cargar-generar">
      ...
      <section class="result-final-flow" aria-label="Navegación de resultado final">
        <button class="result-final-step is-active" type="button" data-resultado-wizard-go="cargar" data-proceso-step="cargar-generar"><span><strong>Cargar</strong></span></button>
        <button class="result-final-step is-locked" type="button" data-resultado-wizard-go="maestro" data-proceso-step="maestro"><span><strong>Maestro</strong></span></button>
        <button class="result-final-step is-locked" type="button" data-resultado-wizard-go="versiones" data-proceso-step="versiones"><span><strong>Versiones</strong></span></button>
        <button class="result-final-step is-locked" type="button" data-resultado-wizard-go="checklist" data-proceso-step="checklist"><span><strong>Checklist</strong></span></button>
        <button class="result-final-step is-locked" type="button" data-resultado-wizard-go="reporte" data-proceso-step="reporte"><span><strong>Reporte</strong></span></button>
      ...
      <section class="result-final-wizard">
        ...
        <article class="result-final-wizard-panel" data-resultado-wizard-panel="maestro" hidden>
          <article class="result-final-panel result-final-panel--video">
            <header><div><h3>Video maestro</h3></div><span id="resultadoFinalVideoEstado">Sin video</span></header>
        ...
        <article class="result-final-wizard-panel" data-resultado-wizard-panel="versiones" hidden>
          <article class="result-final-panel result-final-panel--platforms">
            <header><div><h3>Versiones por plataforma</h3></div><span id="resultadoFinalVersionesEstado">0</span></header>
        ...
        <article class="result-final-wizard-panel" data-resultado-wizard-panel="checklist" hidden>
          <article class="result-final-panel result-final-panel--checklist">
            <header><div><h3>Control final</h3></div><span id="resultadoFinalChecklistEstado">0</span></header>
        ...
        <article class="result-final-wizard-panel" data-resultado-wizard-panel="reporte" hidden>
          <article class="result-final-panel result-final-panel--report">
            <header><div><h3>Recomendaciones y entregables</h3></div><span id="resultadoFinalReporteEstado">0</span></header>
