export function renderDiagnosticoView() {
  return `
    <section class="aj-view-card diagnostic-page">
      ...
      <p>Esta pantalla queda activa para revisar FFmpeg, carpetas, módulos críticos, Gemini, biblioteca, producción, resultado, audio, efectos, rutas y cierre completo del rediseño.</p>
      <div class="aj-tags"><span>FFmpeg</span><span>Carpetas</span><span>Módulos</span><span>Gemini</span><span>Biblioteca</span><span>Producción</span><span>Adaptación</span><span>Resultado</span><span>Audio</span><span>Efectos</span><span>Reintento</span><span>Bloque 18</span></div>
