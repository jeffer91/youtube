    ...
    <section class="aj-view-card plan-view" data-plan-root>
      <div class="plan-hero">
        <div>
          ...
          <p>Revisa el plan. El plan absorbe Entendimiento, Biblioteca y se genera por partes validadas.</p>
        </div>
      ...
      <footer class="plan-footer"><div><strong>Siguiente paso</strong><span>Cuando el plan este listo, puedes continuar al siguiente modulo.</span></div><button id="planProducirBtn" class="primary-button" type="button" disabled>Continuar</button></footer>
    </section>
  `;
}
