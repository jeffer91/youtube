...
function verificarPantallas() {
  ...
  const pantallas = [
    ...
    ['app/pantallas/produccion.view.js', 'Producción maestro', ['data-produccion-root', 'data-proceso-root="produccion-maestro"', 'data-proceso-resumen="produccion-maestro"', 'data-produccion-wizard-panel="cargar"', 'data-produccion-wizard-panel="adaptacion"']],
    ...
    ['app/pantallas/resultado.view.js', 'Resultado final', ['data-resultado-root', 'data-proceso-root="resultado-final"', 'data-proceso-resumen="resultado-final"', 'data-resultado-wizard-panel="cargar"', 'data-resultado-wizard-panel="reporte"']],
...
function verificarEstilos() {
  const estilos = [
    ...
    ['app/produccion-maestro.css', ['produccion-flow', 'produccion-wizard-panel']],
    ['app/adaptacion.css', ['adaptacion-flow', 'adaptacion-wizard-panel']],
    ['app/resultado-final.css', ['resultado-flow', 'resultado-wizard-panel']],
