...
export async function crearEdicionTikTokCuadradoCentro({ entrada, entendimiento, audio = null, transcripcion = null, edicionDinamica = null, opciones = {}, progreso = null } = {}) {
  ...
  const visualDinamico = combinarVisualConMotor(visualBase, motorEfectos);
  ...
  const detalleFiltro = { ...detalleFiltroBase, filtroVideo: visualDinamico.filtroVideo, filtroVideoBase: detalleFiltroBase.filtroVideo, capasTranscripcion, visualDinamico, motorEfectos, sonidos };
  ...
  await reportarModulo(progreso, { etapa: 'editar', porcentaje: 91, titulo: 'Edición cuadrada lista', detalle: `Visuales: ${visualDinamico.omitido ? 'no' : 'sí'} · motor: ${motorEfectos?.omitido ? 'no' : 'sí'} · audio/sonidos: ${sonidos?.omitido ? 'no' : 'sí'}.`, archivo: 'editar/tiktok-cuadrado-centro/tiktok-cuadrado-centro.service.js' });
