...
export async function procesarTiempoDinamico({ entrada, entendimiento, transcripcion = null, cortes = null, config, carpetaEdicionDinamica, opciones = {}, progreso = null } = {}) {
  ...
  if (!cortes || cortes.omitido || !cortes.planCortes?.segmentosConservados?.length) {
    await reportarModulo(progreso, { etapa: 'edicion-dinamica', porcentaje: 69, titulo: 'Tiempos sin cambios', detalle: 'No se ajustaron tiempos porque no se aplicaron cortes.', archivo: 'editar/edicion-dinamica/tiempo/tiempo.conexion.js' });
  ...
  await reportarModulo(progreso, { etapa: 'edicion-dinamica', porcentaje: 69, titulo: 'Creando mapa de tiempo', detalle: 'Convirtiendo tiempos originales a tiempos editados.', archivo: 'editar/edicion-dinamica/tiempo/crear-mapa-tiempo.js' });
  ...
  await reportarModulo(progreso, { etapa: 'edicion-dinamica', porcentaje: 70, titulo: 'Ajustando transcripción', detalle: `${mapaTiempo.bloques?.length || 0} bloques de tiempo preparados.`, datos: { bloques: mapaTiempo.bloques?.length || 0, segundosEliminados: mapaTiempo.segundosEliminados || 0 }, archivo: 'editar/edicion-dinamica/tiempo/ajustar-transcripcion-dinamica.js' });
  ...
  await reportarModulo(progreso, { etapa: 'edicion-dinamica', porcentaje: 71, titulo: 'Ajustando subtítulos', detalle: `${segmentosAjustados.length} segmentos ajustados para el video sin silencios.`, datos: { segmentosAjustados: segmentosAjustados.length }, archivo: 'editar/edicion-dinamica/tiempo/ajustar-subtitulos.js' });
  ...
  await reportarModulo(progreso, { etapa: 'edicion-dinamica', porcentaje: 72, titulo: 'Ajustando textos flotantes', detalle: 'Moviendo textos y momentos importantes al nuevo tiempo del video.', archivo: 'editar/edicion-dinamica/tiempo/ajustar-textos-flotantes.js' });
  ...
  await reportarModulo(progreso, { etapa: 'edicion-dinamica', porcentaje: 73, titulo: 'Reconstruyendo capas', detalle: 'Preparando subtítulos y textos para FFmpeg.', archivo: 'transcripcion/capas/construir-capas-video.js' });
  ...
  await reportarModulo(progreso, { etapa: 'edicion-dinamica', porcentaje: 74, titulo: 'Tiempos ajustados', detalle: `${segmentosAjustados.length} segmentos ajustados · capas reconstruidas.`, datos: { segmentosAjustados: segmentosAjustados.length, capasReconstruidas: Boolean(capasVideoAjustadas && !capasVideoAjustadas.omitido) }, archivo: 'editar/edicion-dinamica/tiempo/tiempo.conexion.js' });
