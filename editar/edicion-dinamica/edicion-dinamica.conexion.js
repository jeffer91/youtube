...
export async function procesarEdicionDinamica({ entrada, entendimiento, audio = null, transcripcion = null, opciones = {} } = {}) {
  ...
  const resultado = {
    ...
    visual: {
      ok: true,
      pendiente: true,
      mensaje: 'Los efectos visuales dinámicos se conectan en el siguiente bloque.'
    },
    sonidos: {
      ok: true,
      pendiente: true,
      mensaje: 'Los efectos de sonido se conectan en el bloque de sonidos.'
    },
    reportes: {
      edicionDinamica: reporte
    },
    diagnostico,
    creadoEn: new Date().toISOString()
  };
